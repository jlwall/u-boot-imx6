...
static void setup_iomux_enet(void)
{
	...
	gpio_direction_output(IMX_GPIO_NR(1, 27), 0); /* pliny6X PHY rst */
	...
	gpio_set_value(IMX_GPIO_NR(1, 27), 1); /* pliny6X PHY reset */
